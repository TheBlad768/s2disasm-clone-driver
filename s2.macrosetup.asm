...
insn1op	 macro oper,x
	  if (chkop("x","0(") && chkop("x","id(") && chkop("x","slot_rout(") && chkop("x","soundqueue.music0(") && chkop("x","smps_queue.v_playsnd1("))
		!oper	x
	  else
		!oper	1+x
		!org	*-1
...
insn2op	 macro oper,x,y
	  if (chkop("x","0(") && chkop("x","id(") && chkop("x","slot_rout(") && chkop("x","soundqueue.music0(") && chkop("x","smps_queue.v_playsnd1("))
		  if (chkop("y","0(") && chkop("y","id(") && chkop("y","slot_rout(") && chkop("y","soundqueue.music0(") && chkop("y","smps_queue.v_playsnd1("))
			!oper	x,y
		  else
			!oper	x,1+y
			!org	*-1
