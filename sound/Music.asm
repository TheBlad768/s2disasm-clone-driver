...
Music81:	include "sound/music/Mus - 2 Player Menu.asm"
	even
Music82:	include "sound/music/Mus - EHZ.asm"
	even
Music83:	include "sound/music/Mus - MCZ 2P.asm"
	even
Music84:	include "sound/music/Mus - OOZ.asm"
	even
Music85:	include "sound/music/Mus - MTZ.asm"
	even
Music86:	include "sound/music/Mus - HTZ.asm"
	even
Music87:	include "sound/music/Mus - ARZ.asm"
	even
Music88:	include "sound/music/Mus - CNZ 2P.asm"
	even
Music89:	include "sound/music/Mus - CNZ.asm"
	even
Music8A:	include "sound/music/Mus - DEZ.asm"
	even
Music8B:	include "sound/music/Mus - MCZ.asm"
	even
Music8C:	include "sound/music/Mus - EHZ 2P.asm"
	even
Music8D:	include "sound/music/Mus - SCZ.asm"
	even
Music8E:	include "sound/music/Mus - CPZ.asm"
	even
Music8F:	include "sound/music/Mus - WFZ.asm"
	even
Music90:	include "sound/music/Mus - HPZ.asm"
	even
Music91:	include "sound/music/Mus - Options.asm"
	even
Music92:	include "sound/music/Mus - Special Stage.asm"
	even
Music93:	include "sound/music/Mus - Boss.asm"
	even
Music94:	include "sound/music/Mus - Final Boss.asm"
	even
Music95:	include "sound/music/Mus - Ending.asm"
	even
Music96:	include "sound/music/Mus - Super Sonic.asm"
	even
Music97:	include "sound/music/Mus - Invincible.asm"
	even
Music98:	include "sound/music/Mus - Extra Life.asm"
	even
Music99:	include "sound/music/Mus - Title Screen.asm"
	even
Music9A:	include "sound/music/Mus - End of Act.asm"
	even
Music9B:	include "sound/music/Mus - Game Over.asm"
	even
Music9C:	include "sound/music/Mus - Continue.asm"
	even
Music9D:	include "sound/music/Mus - Got Emerald.asm"
	even
Music9E:	include "sound/music/Mus - Credits.asm"
	even
Music9F:	include "sound/music/Mus - Drowning.asm"
	even
